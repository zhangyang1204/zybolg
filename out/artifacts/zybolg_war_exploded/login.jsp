...
<%--    <link rel="stylesheet" type="text/css" href="css/pageStyle.css">--%>
    <style type="text/css">
        ...
        body{
            width: 100%;
            height:100%;
            background-image: url(img/背景8.jpg);
...
<div class="container" style="width: 500px;height: 600px;margin-top:50px;padding:50px;background-color: white;opacity: 0.85">
    ...
    <form action="${pageContext.request.contextPath}/loginServlet" method="post">
        ...
        <div class="form-inline">
            ...
            <input style="width: 50%" type="text" name="verifycode" class="form-control" id="verifycode" placeholder="请输入验证码" style="width: 120px;"/>
